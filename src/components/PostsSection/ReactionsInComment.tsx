...
function TabPanel(props: TabPanelProps) {
  ...
  const { value, index, reactionType, commentId, postId, counts } = props;
  ...
  const loadMore = useCallback(async () => {
    ...
    setIsLoading(false);
  }, [limit, commentId, reactionType, dispatch, postId, reactions]);
...
interface ReactionsInCommentProps {
  postId: string;
  commentId: string;
  counts: {
    [key in ReactionType]: number;
...
const Reactions: React.FC<ReactionsInCommentProps> = React.forwardRef(
  ({ postId, counts, commentId }, ref) => {
